...
const teams = [
  {
    avatar: require('./avatar-matrix.png'),
    name: 'Matrix 蘇柏瑋',
    head: 'COO 營運長',
    duty: '網頁開發、團隊文化塑造、市場洞悉',
    description: 'Reprehenderit do adipisicing commodo sint consectetur Non ullamco commodo nostrud cillum consectetur.',
  },
  {
    avatar: require('./avatar-yuhao.png'),
    name: 'YuHao 范育豪',
    head: 'CEO 執行長',
    duty: '專案管理、資源整合、對外公關',
    description: 'Reprehenderit do adipisicing commodo sint consectetur Non ullamco commodo nostrud cillum consectetur.',
...
export default function AboutUs() { // add async in between "default" & "function" to activate await
      ...
      <div className={styles.container}>
        <div className={styles.banner}>
          <div className={styles.banner_breadcrumb}>
            <Breadcrumb separator={'>'} items={[{ title: '首頁' }, { title: '關於我們' }]} />
          </div>
          <div className={styles.banner_title}>
            <h1>
              <Image src={titleImage} alt={'FozirTex'} style={{marginRight: 24}} />
              的核心價值
            </h1>
          </div>
          <div className={styles.banner_content}>
            <Image src={quotationImage} alt={'Non deserunt in consequat minim tempor. Ad aute laboris voluptate. Nostrud do cillum dolor in officia cupidatat do amet ex irure. Mollit sunt eu pariatur nisi mollit commodo eu veniam irure.'} />
            {/*<p>*/}
          ...
          <main>
            <div className={styles.court_inner}>
              ...
              <div className={styles.court_inner_content}>
                我們希望透過 BadX App，整合所有羽球圈生態的資訊，包含業者的場地管理、場主的出租球場管理、球友們的羽球權益，都包含在這個App裡。以這樣的方式去...Tempor anim eiusmod nostrud ipsum.
              </div>
            </div>
          </main>
        </section>
                ...
                <Col key={value.name} md={8} sm={24}>
                  <div className={styles.team_item}>
                    <div className={styles.team_item_avatar}>
                      <Image src={value.avatar} alt={value.name} />
                    </div>
                    <div className={styles.team_item_name}>
                      {value.name}
                    </div>
                    <div className={styles.team_item_head}>
                      {value.head}
                    </div>
